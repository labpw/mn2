...
Porównanie będzie wykonane w odniesieniu do rozwiązania analitycznego wyrażonego przez funkcję:
$$ g(t) = 3(1 + x^2)^{2/3} - 2.772 $$
...
d) **Dokumentacja**:
   ...
   - Dokumentacja powinna być dostarczona w formie sprawozdania w formacie PDF.
