...
1. **Obliczenie pośredniego punktu**: Najpierw obliczamy położenie i wartość funkcji w pośrednim punkcie kroku 
...
$$y_i + 0.5h f(x_i, y_i))$$
 ...
 Dzięki temu uzyskujemy estymatę wartości funkcji $y'$ w połowie kroku.
